...
namespace bow {
	...
	typedef std::shared_ptr<class D3DShaderProgram> D3DShaderProgramPtr;
	typedef std::shared_ptr<class D3DTextureUnits> D3DTextureUnitsPtr;
	typedef std::shared_ptr<class D3DFramebuffer> D3DFramebufferPtr;
	...
	private:
		...
		ComPtr<ID3D11Resource>	m_backBuffers[m_numBuffers];
		ComPtr<ID3D11Resource>	m_depthBuffers[m_numBuffers];
