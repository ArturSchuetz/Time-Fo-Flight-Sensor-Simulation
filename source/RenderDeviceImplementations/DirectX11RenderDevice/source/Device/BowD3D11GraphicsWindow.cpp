...
namespace bow {
	...
	bool D3DGraphicsWindow::Initialize(unsigned int width, unsigned int height, const std::string& title, WindowType windowType, D3DRenderDevice *device)
	{
		...
		LOG_INFO("DirectX11-Window sucessfully initialized!");
		return result;
	}
	...
	{
		LOG_TRACE("D3DGraphicsWindow released");
	}

	void* D3DGraphicsWindow::VGetWindowHandle() const
	{
		return m_hwnd;
	}
	...
	void D3DGraphicsWindow::VSetWindowTitle(const char* title) const
	{
		// TODO
	}
	...
	bool D3DGraphicsWindow::VIsVisible() const
	{
		// TODO
		return false;
	}
