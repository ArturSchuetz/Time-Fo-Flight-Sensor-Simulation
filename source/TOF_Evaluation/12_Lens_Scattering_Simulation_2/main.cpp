...
int main()
{
	...
	runAnalysis("/data/Kinect_v2_Calibration.xml", "F:\\Kamera_Evaluation\\\Simulation\\Recordings_Lens_Scattering_1");
	runAnalysis("/data/Kinect_v2_Calibration.xml", "F:\\Kamera_Evaluation\\\Simulation\\Recordings_Lens_Scattering_2");
	runAnalysis("/data/Kinect_v2_Calibration.xml", "F:\\Kamera_Evaluation\\\Simulation\\Simulated_Recordings");
	g_renderer.Stop();
	return 0;
}
