...
{
	g_renderer.Start();
	runAnalysis("/data/Kinect_v2_Calibration.xml", "F:\\Kamera_Evaluation\\\Simulation\\Recordings_Roughness");
	runAnalysis("/data/Kinect_v2_Calibration.xml", "F:\\Kamera_Evaluation\\\Simulation\\Recordings_Roughness_2");
